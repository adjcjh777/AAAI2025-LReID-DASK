...
def fast_test_p_s(model, all_train_sets, all_test_only_sets,set_index, args, logger=None,writer=None, return_avg=False):
    ...
    for temp_loaders in loaders:
        ...
        wandb.log({
            f"results/{dataset_name}_mAP": map,
            f"results/{dataset_name}_R@1": rank1,
            "training_phase": set_index
        })
    ...
    wandb.log({
        "results/Seen-Avg_mAP": aver_seen_mAP,
        "results/Seen-Avg_R@1": aver_seen_r1,
        "results/UnSeen-Avg_mAP": aver_unseen_mAP,
        "results/UnSeen-Avg_R@1": aver_unseen_r1,
        "training_phase": set_index
    })
